...
class SphinxClient
{
    ...
    const SPH_RANK_BM15 = 1; // statistical mode, BM25 ranking only (faster but worse quality)
    ...
    function __construct()
    {
        ...
        $this->_ranker               = self::SPH_RANK_PROXIMITY_BM15;
        $this->_rankexpr             = "";
...
function sphPackI64($v)
{
    ...
    if (function_exists("bcmul")) {
        ...
        } elseif (bccomp($v, "9223372036854775807") > 0) {
